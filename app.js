...
function sumAndMultiply(a, b, c) { //eslint-disable-line
  ...
  var firstMsg = a + ' and ' + b + ' and ' + c + ' sum to 16.';
  var secondMsg = 'The product of ' + a + ' and ' + b + ' and ' + c + ' is 140.';
  return [secondSum[0], secondProduct[0], firstMsg, secondMsg];
}
...
function sumArray(sumArr) { //eslint-disable-line
  ...
  var theMessage = testArray[0] + ',' + testArray[1] + ',' + testArray[2] + ' was passed in as an array of numbers, and ' + secondSum[0] + ' is their sum.';
  return [secondSum[0], theMessage];
}
...
function multiplyArray(multArr) { //eslint-disable-line
  ...
  var secondProduct = multiply(firstProduct[0], testArray[2]);
  var theMessage = 'The numbers ' + testArray[0] + ',' + testArray[1] + ',' + testArray[2] + ' have a product of ' + secondProduct[0] + '.';
  return [secondProduct[0], theMessage];
}
...
function multiplyAnyArray(dynamicArray) { //eslint-disable-line
  ...
  for(var i = 1; i < testDynamicArray.length; i++) {
    var thisProduct = multiply(testDynamicArray[0], testDynamicArray[i]);
    storage *= thisProduct[0];
    var theMessage = 'The numbers ' + testDynamicArray + ' have a product of ' + storage + '.';
  }
  return [storage, theMessage];
}
// Here is the test for multiplyArray(); uncomment it to run it
